...
void CInfoPanelManager::CreateHeader()
{
   ...
   ObjectSetString(0, titleLabel, OBJPROP_FONT, "Meiryo UI");
...
void CInfoPanelManager::CreateIndicatorRows()
{
   for(int i = 0; i < m_indicatorCount; i++)
   {
      ...
      color rowColor = (i % 2 == 0) ? COLOR_PANEL_BG : COLOR_TITLE_BG;

      // 行背景
      string rowBG = m_prefix + "RowBG" + idx;
      ...
      ObjectSetInteger(0, rowBG, OBJPROP_BGCOLOR, rowColor);
      ...
      string nameLabel = m_prefix + "Name" + idx;
      ...
      // ON/OFF状態
      string statusLabel = m_prefix + "Status" + idx;
      ...
      // BUYシグナル
      string buyLabel = m_prefix + "Buy" + idx;
      ...
      // SELLシグナル
      string sellLabel = m_prefix + "Sell" + idx;
